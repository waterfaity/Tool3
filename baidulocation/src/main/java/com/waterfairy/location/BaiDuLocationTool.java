...
public class BaiDuLocationTool {
    ...
    public static BaiDuLocationTool newInstance() {
        return new BaiDuLocationTool();
    }

    public void initLocationOption(Context applicationContext) {
...
//可选，默认gcj02，设置返回的定位结果坐标系，如果配合百度地图使用，建议设置为bd09ll;
        locationOption.setCoorType("d09ll");
