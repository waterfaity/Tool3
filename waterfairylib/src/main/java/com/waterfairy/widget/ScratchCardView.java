 ...
 * @info:
 */
public class ScratchCardView extends BaseView {
    ...
    public void onViewMeasure(boolean changed, int width, int height) {
        ...
        if (!TextUtils.isEmpty(text)) {
            ...
            mCanvas.drawText(text, (getWidth() - textRect.width()) / 2, (getHeight() - textRect.height()) / 2 + textRect.height(), paint);
        }
        mPath = new Path();
    }
            ...
            protected Void doInBackground(Void... voids) {
                if (onScratchListener != null) {
                    if (mBitmap != null && !mBitmap.isRecycled()) {
                        ...
                        onScratchListener.onScratch(ScratchCardView.this, tempPix / (float) totalPix);
                    }
                }
                return null;
            }
    ...
    public interface OnScratchListener {
        void onScratch(ScratchCardView scratchCardView, float radio);
    }
}
